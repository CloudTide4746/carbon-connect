            ...
            <div className='flex space-x-4'>
              {[Twitter, Github, Linkedin].map((Icon, i) => (
                <a
                  key={i}
                  href='#'
                  className='bg-slate-800 p-2 rounded-full hover:bg-eco-green-600 hover:text-white transition-colors duration-300'
                >
            ...
            <ul className='space-y-4'>
              {[
                ...
                <li key={item}>
                  <a
                    href='#'
                    className='flex items-center hover:text-eco-green-400 transition-colors group'
                  >
