...
const steps = [
  {
    icon: Scan,
    title: '监测与确权',
    desc: '卫星遥感自动扫描，AI 算法识别林地碳储量，区块链生成唯一数字凭证。'
  },
  {
    icon: Database,
    title: '核算与上链',
    desc: '多源数据融合计算，生成标准化的碳信用资产，信息实时上链存证。'
  },
  {
    icon: TrendingUp,
    title: '挂牌与交易',
    desc: '资产接入交易平台，企业按需购买，智能合约自动完成资金结算。'
  },
  {
    icon: Wallet,
    title: '收益分配',
    ...
    <section className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600">从森林到收益，全链路数字化闭环</p>
        </div>
