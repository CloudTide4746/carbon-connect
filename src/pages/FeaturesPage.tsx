...
const features = [
  {
    ...
    title: "AI遥感监测",
    description:
      "利用高分辨率卫星与无人机影像，结合深度学习算法，自动识别林地边界与植被类型。",
  },
  {
    icon: TreePine,
    title: "碳汇精准核算",
    description:
      "基于多源数据融合技术，实时计算森林碳储量，为碳汇交易提供可信数据支撑。",
  },
  {
    icon: AlertTriangle,
    title: "智能预警系统",
    description:
      "全天候监控火灾隐患与非法砍伐行为，异常情况秒级报警，守护绿色资产。",
  },
  {
    icon: TrendingUp,
    title: "数字化交易",
    description:
      "构建透明、高效的碳汇交易撮合平台，打通乡村卖方与企业买方的信息壁垒。",
  },
  {
    icon: Bot,
    title: "数字人服务",
